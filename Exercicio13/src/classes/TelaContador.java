...
public class TelaContador extends javax.swing.JFrame {
    ...
    private void btnContActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContActionPerformed
        ...
        DefaultListModel lista = new DefaultListModel(); // classe para lista conforme parametros do usuário
        
        for (int c = i; c <= f; c += p) { // iteração baseado nos valores do usuário
            lista.addElement(c); // variável lista com método para adicionar o resultado das iterações
        }
        
        lstCont.setModel(lista); // exibe no painel os valores adicionados na lista
